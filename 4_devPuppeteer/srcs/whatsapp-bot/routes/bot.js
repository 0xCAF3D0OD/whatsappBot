...
bot.get(('/about/scrape'), async (req, res) => {
    try {
        ...
        // res.send("page chargee avec succes, " + await page.evaluate(() => {
        //     const element = document.querySelector('svg[xmlns="http://www.w3.org/2000/svg"][width="64"][height="64"]');
        //     if (element) {
        //         return "la balise a bien ete chargee" + element;
        //     }
        //     else {
        //         return "la balise n'a pas pu etre chargee";
        //     }
        // }));
    } catch (error) {
