...
import { FindMeOn } from './Body/FindMeOn.js';
...
export const AstroComponent = () => ({
    ...
    template() {
        ...
        <section>
          <div class="p-4">
            <div class="grid grid-cols-1 gap-4 list-none lg:grid-cols-3 
            lg:grid-rows-3 xl:grid-cols-4 xl:grid-rows-4">
              <div class="lg:row-span-2 ring-1 dark:ring-white/10 ring-primary/5 bg-white 
              dark:bg-secondary shadow-xl dark:shadow-thick rounded-3xl p-8">
              ...
              <div class="ring-1 dark:ring-white/10 ring-primary/5 rounded-3xl justify-between 
              shadow-xl dark:shadow-thick items-center flex flex-col p-8 h-full bg-white dark:bg-secondary"
              >
                <div class="w-full">
                  <p class="text-xl font-normal tracking-tight text-primary dark:text-white lg:text-8xl">
                    Find me on
                  </p>
                </div>
                <div class="grid mt-4 grid-cols-4 md:grid-cols-8 lg:grid-cols-4 gap-y-4 gap-4 justify-center w-full">
                <div x-data="FindMeOn" x-html="template()" class="button-custom-body"></div>
<!--                  <a-->
<!--                    href="#_"-->
<!--                    class="flex items-center justify-center aspect-square shadow-xl dark:shadow-thick -->
<!--                    hover:bg-zinc-100 dark:hover:bg-primary ring-1 bg-zinc-50 dark:ring-white/10 -->
<!--                    ring-primary/5 dark:bg-tertiary rounded-lg hover:ring-primary/5 dark:hover:ring-white/20 -->
<!--                    duration-300 group transition-all h-12 w-12"-->
<!--                  >-->
<!--                    <svg-->
<!--                      xmlns="http://www.w3.org/2000/svg"-->
<!--                      class="icon icon-tabler icon-tabler-brand-github h-6 w-6 group-hover:scale-125 -->
<!--                      duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50"-->
<!--                      viewBox="0 0 24 24"-->
<!--                      stroke-width="0.8"-->
<!--                      stroke="currentColor"-->
<!--                      fill="none"-->
...
<!--                        d="M9 19c-4.3 1.4 -4.3 -2.5 -6 -3m12 5v-3.5c0 -1 .1 -1.4 -.5 -2c2.8 -.3 -->
<!--                        5.5 -1.4 5.5 -6a4.6 4.6 0 0 0 -1.3 -3.2a4.2 4.2 0 0 0 -.1 -3.2s-1.1 -.3 -->
<!--                        -3.5 1.3a12.3 12.3 0 0 0 -6.2 0c-2.4 -1.6 -3.5 -1.3 -3.5 -1.3a4.2 4.2 0 -->
<!--                        0 0 -.1 3.2a4.6 4.6 0 0 0 -1.3 3.2c0 4.6 2.7 5.7 5.5 6c-.6 .6 -.6 1.2 -.5 2v3.5"-->
<!--                      ></path></svg-->
<!--                    >-->
<!--                  </a>-->
                  <a
                  ...
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="icon icon-tabler icon-tabler-brand-behance h-6 w-6 group-hover:scale-125 
                      duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50"
                      viewBox="0 0 24 24"
                      stroke-width="0.8"
                      stroke="currentColor"
                  ...
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="icon icon-tabler icon-tabler-brand-threads h-6 w-6 group-hover:scale-125 
                      duration-300 text-primary dark:text-white group-hover text-primary:dark:text-white/50"
                      viewBox="0 0 24 24"
                      stroke-width="0.8"
                      stroke="currentColor"
                  ...
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="icon icon-tabler h-6 w-6 group-hover:scale-125 duration-300 text-primary 
                      dark:text-white group-hover text-primary:dark:text-white/50 icon-tabler-brand-dribbble"
                      viewBox="0 0 24 24"
                      stroke-width="0.8"
                      stroke="currentColor"
                      fill="none"
              ...
              >
                <div>
                  <p
                    class="ext-xl tracking-tight font-medium text-primary dark:text-white md:text-6xl"
                  >
                    Monomod
                  </p>
              ...
              <div
                class="ring-1 dark:ring-white/10  ring-primary/5 flex flex-col justify-between items-center rounded-3xl shadow-xl dark:shadow-thick p-8  bg-white dark:bg-secondary overflow-hidden text-center lg:text-left"
              >
                <div>
                  <p
                ...
                <div class="mt-8">
                  <div class="flex flex-wrap">
                    ...
                    >
                      ...
                      <span class="ml-2.5"> Tailwind CSS</span>
                    </div>
                  </div>
                  <p
              ...
              <div
                class="ring-1 dark:ring-white/10 ring-primary/5 flex flex-col p-8 h-full justify-center items-center rounded-3xl overflow-hidden relative lg:col-span-2 lg:row-start-4 bg-white dark:bg-secondary shadow-xl dark:shadow-thick"
              >
              ...
              <div
                class="lg:col-span-2 xl:col-span-1 h-full flex flex-col justify-between lg:row-span-2 ring-1 dark:ring-white/10 ring-primary/5 bg-white dark:bg-secondary shadow-xl dark:shadow-thick rounded-3xl p-8"
              >
                <p
